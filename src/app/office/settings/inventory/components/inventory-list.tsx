    ...
    <div className="mt-8 flow-root">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-base font-semibold leading-6 text-slate-900">Items</h1>
        ...
        <table className="min-w-full divide-y divide-slate-300">
          <thead className="bg-slate-50">
            <tr>
              ...
              <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-slate-900">Room</th>
              <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-slate-900">Default Volume (cft)</th>
          ...
          <tbody className="divide-y divide-slate-200 bg-white">
            {activeItems.length === 0 ? (
              <tr>
                <td colSpan={4} className="py-4 pl-4 pr-3 text-sm text-slate-500 text-center sm:pl-6">
              ...
              activeItems.map((item) => (
                <tr key={item.id}>
                  ...
                  <td className="whitespace-nowrap px-3 py-4 text-sm text-slate-500">{item.room || '-'}</td>
                  <td className="whitespace-nowrap px-3 py-4 text-sm text-slate-500">{item.default_volume}</td>
