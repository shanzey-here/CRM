...
async function main() {
  ...
  // Both auto_send test threads had subject "Re: AI test - assist quote ..."
  const res = await gmail.users.messages.list({ userId: 'me', q: 'in:sent subject:"AI test - assist quote"', maxResults: 10 })
