...
async function run() {
  ...
  await page.waitForURL('http://127.0.0.1:3001/office')
  ...
  // 2. Leads Kanban
  await page.goto('http://127.0.0.1:3001/office/leads')
  ...
  await page.goto('http://127.0.0.1:3001/office/clients')
  await page.waitForTimeout(2000)
  ...
  // 4. Settings Page
  await page.goto('http://127.0.0.1:3001/office/settings')
  await page.waitForTimeout(2000)
  ...
  // 5. Super Admin
  await page.goto('http://127.0.0.1:3001/super-admin')
  await page.waitForLoadState('networkidle')
  await page.screenshot({ path: path.join(SCREENSHOTS_DIR, 'before-super-admin.png'), fullPage: true })
  console.log('Took super admin screenshot')
