-- Fix Analytics DB Error Codes
-- Replaces generic RAISE EXCEPTION strings with deliberate PT403 error codes for robust UI checking.
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    RAISE EXCEPTION 'Tenant lacks analytics entitlement' USING ERRCODE = 'PT403';
  END IF;
